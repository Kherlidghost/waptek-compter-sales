...
function SubmitButton() {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="rounded-md bg-emerald-600 px-5 py-3 text-sm font-bold text-white hover:bg-emerald-700 disabled:cursor-not-allowed disabled:bg-slate-400"
    >
...
function ResetPasswordForm() {
  ...
  return (
    <section className="w-full max-w-md rounded-2xl border border-slate-200 bg-surface p-8 shadow-xl shadow-slate-950/5">
